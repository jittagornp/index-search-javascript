...
3. which it will separate keywords from sentence that you needed make an index (you can define by yourself), by default use the white space for separate keywords (you can custom it).
